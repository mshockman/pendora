...
var DataHeaderPage = /*#__PURE__*/function () {
...
var Component = /*#__PURE__*/function (_Publisher) {
...
var Overlay = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Overlay, [{
    ...
    key: "clearFX",
    value: function () {
      var _clearFX = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
...
var COLUMN_MAP = new WeakMap();

var DataGridHeader = /*#__PURE__*/function (_Publisher) {
  _inherits(DataGridHeader, _Publisher);

  var _super = _createSuper(DataGridHeader);
  ...
  function DataGridHeader() {
    ...
    _destroyColumn.add(_assertThisInitialized(_this));

    _initColumn.add(_assertThisInitialized(_this));
    ...
    _columnElementMap.set(_assertThisInitialized(_this), {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldSet(_assertThisInitialized(_this), _columnElementMap, new WeakMap());
    ...
    if (_classPrivateFieldGet(_assertThisInitialized(_this), _sortable)) {
      ...
      _classPrivateFieldGet(_assertThisInitialized(_this), _sorter).on(['sort-append', 'sort-complete', 'sort-start'], function () {
      ...
      _classPrivateFieldGet(_assertThisInitialized(_this), _sorter).on("sort-append", function () {
        _classPrivateFieldSet(_assertThisInitialized(_this), _columns, _classPrivateMethodGet(_assertThisInitialized(_this), _compileColumnListFromDom, _compileColumnListFromDom2).call(_assertThisInitialized(_this)));
      ...
      _classPrivateFieldGet(_assertThisInitialized(_this), _sorter).on('sort-start', function () {
        _classPrivateFieldSet(_assertThisInitialized(_this), _columns, _classPrivateMethodGet(_assertThisInitialized(_this), _compileColumnListFromDom, _compileColumnListFromDom2).call(_assertThisInitialized(_this)));
  ...
  _createClass(DataGridHeader, [{
    ...
    value: function removeColumn(column) {
      ...
      if (index !== -1) {
        ...
        _classPrivateMethodGet(this, _destroyColumn, _destroyColumn2).call(this, column);
    ...
    value: function clearColumns() {
      var _iterator2 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _columns)),
          _step2;
    ...
    value: function appendColumn(column) {
      if (!(column instanceof DataColumn)) {
        column = new DataColumn(_objectSpread(_objectSpread({}, column), {}, {
          sortable: column.sortable !== false && _classPrivateFieldGet(this, _sortable)
        }));
      }

      _classPrivateMethodGet(this, _initColumn, _initColumn2).call(this, column);

      _classPrivateFieldGet(this, _columns).push(column);

      column.appendTo(_classPrivateFieldGet(this, _body));
    ...
    value: function insertColumn(column, index) {
      if (!(column instanceof DataColumn)) {
        ...
        var cache = COLUMN_MAP.get(column);
      ...
      _classPrivateFieldGet(this, _columns).splice(index, 0, column);

      index = _classPrivateFieldGet(this, _columns).indexOf(column);

      var after = _classPrivateFieldGet(this, _columns)[index + 1];

      if (after) {
        _classPrivateFieldGet(this, _body).insertBefore(column.element, after.element);
      } else {
        column.appendTo(_classPrivateFieldGet(this, _body));
      }
    ...
    get: function get() {
      ...
      var _iterator3 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _columns)),
          _step3;
    ...
    key: "columns",
    get: function get() {
      return _classPrivateFieldGet(this, _columns).splice(0);
    }
  }]);
...
var _columnElementMap = new WeakMap();

var _render = new WeakSet();

var _initColumn = new WeakSet();

var _destroyColumn = new WeakSet();
...
var _initColumn2 = function _initColumn2(column) {
  var _this2 = this;
  ...
  _classPrivateFieldGet(this, _columnElementMap).set(column.element, column);

  return column;
};

var _destroyColumn2 = function _destroyColumn2(column) {
  var cache = COLUMN_MAP.get(column);
  ...
  if (cache) {
    ...
    _classPrivateFieldGet(this, _columnElementMap)["delete"](column.element);
  }
};
...
var _compileColumnListFromDom2 = function _compileColumnListFromDom2() {
  ...
  var _iterator4 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _body).children),
      _step4;
  ...
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      ...
      var column = _classPrivateFieldGet(this, _columnElementMap).get(child);
...
var DataColumn = /*#__PURE__*/function (_Publisher2) {
  _inherits(DataColumn, _Publisher2);

  var _super2 = _createSuper(DataColumn);
