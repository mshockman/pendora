...
export default class Notification2 extends Publisher {
    #element;
    #body;
    #label;
    #content;
    ...
    getFullBodyRect() {
         ...
         * @type {null|Rect}
         */
        let rect = Rect.getBoundingClientRect(this.#content);

        for(let child of this.#content.children) {
            rect = rect.union(Rect.getBoundingClientRect(child));
        }
    ...
    static notify(message, type, {target=null, placement=null, className=null, icon=null, id=null, showFX=null, hideFX=null, showDuration=null, hideDuration=null, template=null, timeout=null, closeOnClick=null, fx=null}={}) {
        ...
        if(target) {
            ...
            let notification = new Notification2(args);
